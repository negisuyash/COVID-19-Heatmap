...
class HeatMapper:
	...
	def summaryData(self):
		internalAPI=InternalDataAPI()
		covid19_data=internalAPI.convertToConsumedJSON(internalAPI.fetchData())#requests.get('https://api.rootnet.in/covid19-in/stats/latest').json()#
		if covid19_data['success']==True:
